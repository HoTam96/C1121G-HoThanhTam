...
<div class="col-lg-3 col-md-3 col-sm-3">
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0"> Tương tác với Customer</p>
        ...
        <ul class="nav flex-column bg-white mb-0">
            ...
            <li class="nav-item">
                <a href="Customer?action=create" class="nav-link text-dark font-italic">
