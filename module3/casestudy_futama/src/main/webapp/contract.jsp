...
<jsp:include page="common/menu_bar_contract.jsp"></jsp:include>
<section class="main">
    <div class="container-fluid">
        <div class="row main-main">
            <jsp:include page="common/vertical_nav_contract.jsp"></jsp:include>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 table-responsive">
                <table id="example" class="table table-striped">
                    ...
                    <tody>
                        <c:forEach var="i" items="${contractList}">
                            <tr>
                                <td>${i.contractId}</td>
                                <td>${i.startDate}</td>
                                <td>${i.endDate}</td>
                                <td>${i.contractDeposit}</td>
                                <td>${i.totalMoney}</td>
                                <td>${i.employeeId.name}</td>
                                <td>${i.customerId.name}</td>
                                <td>${i.serviceId.serviceName}</td>
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"><a
                                            href="Contract?action=edit&id=${i.contractId}">edit</a>Edit
                                    </button>

                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            onclick="getId(${i.contractId})"
