...
import case_study.module.furama_service.PromotionService;
import case_study.module.module_Furama.PromotionManage;
...
public class PromotionManagementImpl implements PromotionService {
    private static Set<PromotionManage> promotionManageSet = new TreeSet<>();
